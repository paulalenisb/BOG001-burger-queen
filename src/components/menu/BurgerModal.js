        ...
        <div className='Overlay'>
          <div className='Modal'>
            ...
            <button
              ...
              onClick={() => {
                setOrder([...order, { product: `${product} ${meatOptn} ${extra}`, quantity: 1, price: data[product].price, total: data[product].price + copyPrice.reduce((finalTotal, currentValue) => finalTotal + currentValue, 0) }])
